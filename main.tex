...
\begin{center}
  \includegraphics[width=3cm]{front/figures/mobilecoin_logo3.pdf}
\end{center}
...
%{\par\centering \textsc{\LARGE \today{}, Draft v0.0.16}\par}
{\par\centering \textsc{\LARGE \today{}, Preview (2/10) v0.0.16}\par}
\bigskip
...
\textbf{DRAFT INFORMATION}: This is just a draft, and may not always be available wherever it is currently hosted. The final version will be published at \url{https://github.com/mobilecoinfoundation}.
