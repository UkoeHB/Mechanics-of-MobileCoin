...
We shed light on secure enclaves in Chapter \ref{chapter:enclaves}, the MobileCoin blockchain is unfolded in Chapter~9, and the MobileCoin consensus protocol used to create the blockchain is elucidated in Chapter 10.%\ref{chapter:consensus}
...
\begin{itemize}
    ...
    \item MobileCoin uses secure enclaves extensively (Chapter \ref{chapter:enclaves}). They have an important role in MobileCoin's privacy model and are essential to the Fog technology (Chapter 11).%[[[fix references]]]\ref{chapter:fog}
\end{itemize}
