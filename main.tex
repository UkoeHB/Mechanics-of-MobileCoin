...
{\par\centering \textsc{\LARGE \today{}, v1.0.0}\par}
%{\par\centering \textsc{\LARGE \today{}, Preview (10/11) v0.0.39}\par}
\bigskip
{\par\centering \textsc{\large koe\footnote{ukoe@protonmail.com}\footnote{Author `koe' worked on this document as part of a private contract with, then as an employee of, MobileCoin, Inc.}}, Kurt M. Alonso\footnote{kurt@oktav.se}
\par}
\vfill{}
